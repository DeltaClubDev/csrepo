...
public class DataConverter {
	...
	public DataConverter(boolean printXMLPersons, boolean printXMLAssets) {
		loadFilePersons(printXMLPersons);
		loadFileAssets(printXMLAssets);
	}
	
	//Persons Object parser and XML generator
	private void loadFilePersons(boolean printXMLPersons) {
		Scanner s = null;
    	try {
	...
	private void loadFileAssets(boolean printXMLAssets) {
		Scanner s = null;
    	try {
